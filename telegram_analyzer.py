...
📊 *Анализ чатов:*
/start \- Ежедневный анализ \(за последние 24 часа\)
/full\_analyze \- Полный анализ истории чатов

🔍 *Режимы анализа:*
Добавьте параметр после команды:
• /start describe \- Общее описание событий
• /start retell \- Подробный пересказ \(по умолчанию\)
• /full\_analyze describe \- Общее описание всей истории
• /full\_analyze retell \- Подробный пересказ всей истории

💬 *Работа с сообщениями:*
• Используйте кавычки для цитирования текста
Пример: Что имелось в виду под \"проблема с Docker\"?

❓ *Дополнительно:*
/help \- Показать это сообщение

*Примечание:* После анализа вы можете задавать вопросы по конкретным частям, цитируя интересующий текст\.
"""
...
def main():
    ...
    application.add_handler(chat_handler.handler)
    
    logger.info("\n" + "="*40)
    logger.info("Бот запущен и готов к работе!")
    logger.info("Используйте /help для просмотра списка команд")
    logger.info("="*40 + "\n")
